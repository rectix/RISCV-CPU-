...
module wbu#(parameter PC_INIT = `PC_INIT)(
    ...
    input logic                 mem_stall_o,


    //register file interface
    input logic                 regfile_w_enable_o,
    input logic [4:0]           regfile_rdt_addr_o,
    input logic [`XLEN-1:0]     regfile_rdt_data_o,



    //instructions  interface     

    input logic [`XLEN-1:0]     wbu_pc_o,
    input logic [`ILEN-1:0]     wbu_instruct_o,
    input logic [5:0]           wbu_instruct_type_o,

    input logic [4:0]           wbu_rdt_addr_o,
    input logic [`XLEN-1:0]     wbu_rdt_data_o,

    input logic                 wbu_bubble_o,
